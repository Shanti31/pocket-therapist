        ...
        <div className="flex-1 flex flex-col items-center justify-center px-6 py-8">
          <div className="w-full max-w-sm">
            ...
            <div className="text-center mb-6">
              <span className="text-6xl">{PAIN_EMOJIS[selectedPain]}</span>
              <p className="text-2xl font-bold text-gray-800 mt-2">{selectedPain}<span className="text-base font-normal text-gray-400">/10</span></p>
            </div>
      ...
      {phase === 'exercise' && (
        <div className="flex-1 flex flex-col">
          <div className="flex-1 flex flex-col items-center justify-center px-6 py-8">
              ...
              <div className="mb-6 text-center">
                <div
                  className={`text-6xl font-mono font-bold transition-colors ${
                    timeRemaining === 0 ? 'text-green-600' : 'text-blue-600'
                  }`}
                >
                  {formatTime(timeRemaining)}
                </div>
                {timeRemaining === 0 && (
                  <p className="text-green-600 font-medium mt-2 text-lg">✓ Temps écoulé !</p>
                )}
                {timeRemaining > 0 && (
                  <button
            ...
            {/* Repetitions display (if no timer) */}
            {currentExercise.repetitions && timeRemaining === null && (
              <div className="mb-6 text-center">
                <div className="text-6xl font-bold text-blue-600">
                  {currentExercise.repetitions}
                </div>
                <p className="text-gray-500 mt-1 text-lg">répétitions</p>
              </div>
            )}
          </div>
